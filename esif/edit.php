    ...
    <form action="new_student.php" method="post" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="col-sm-6">
          ...
          if($class=='vi'||$class=='vii'||$class=='viii'){
            ...
            <select onchange="group_selected(this.value)" name="group" id="group" class="form-control" required>
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          ...
          if($class=='vi'||$class=='vii'||$class=='viii')
          {
            echo '<label>Optional Subject:</label>
  ...
  if (group == "") {
    ...
    xmlhttp.onreadystatechange = function() {
      if (this.readyState == 4 && this.status == 200) {
        document.getElementById("show_subject").innerHTML = this.responseText;
      }
    };
    xmlhttp.open("GET","show_elective_subject.php?group="+group,true);
    xmlhttp.send();
  }
}
